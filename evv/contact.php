			...
			<nav id="off-canvas-menu">				
				<ul class="expander-list">				
					...
					<li>
						<span class="name">
							<span class="expander">-</span>
							<a href="soldes.php"><span class="act-underline">Soldes<span class="badge badge--menu badge--color">SALE</span></span></a>
								</span>
					</li>					
					...
					<div class="row">					
						...
						<!-- espace pour inscrire-->
							<div class="account-row-list pull-right mobile-menu-off">
								...
								<ul>
									<li><a href="wishlist.php"><span class="icon icon-place"></span>No<b>s point de vente</b></a></li>
								...
								<nav class="navbar navbar-color-white">
									<div class="responsive-menu mainMenu">	
										...
										<ul class="nav navbar-nav">
											<li class="dl-close"><a href="#"><span class="icon icon-close">fremer</span></a></li>								
											...
											<li class="dropdown dropdown-mega-menu">
												...
												<a href="soldes.php" class="dropdown-toggle" data-toggle="dropdown">
													<span class="act-underline">Soldes<span class="bdge badge--menu badge--color">solde</span></span></a>
			...
			<div class="container inset-bottom-60">
				<div class="row">
					...
					<div class="col-sm-8 col-md-4">
						<!-- -->
						<div class="mobile-collapse">
							<h4 class="text-left text-uppercase  title-under  mobile-collapse__title text-uppercase">information</h4>
							<div class=" mobile-collapse__content">							
								<!-- address -->
								<address class="box-address">
